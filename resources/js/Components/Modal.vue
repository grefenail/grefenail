        ...
        <transition leave-active-class="duration-200">
            <div v-show="show" class="fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-50" scroll-region>
                ...
                <transition enter-active-class="ease-out duration-300"
                    ...
                    <div v-show="show" class="flex items-center justify-center h-full">
                        <div class="mb-6 bg-white rounded-lg overflow-hidden shadow-xl transform transition-all w-full sm:mx-auto"
                            :class="maxWidthClass">
                            <slot v-if="show" />
                        </div>
                    </div>
